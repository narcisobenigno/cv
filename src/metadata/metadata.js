module.exports = {
  ...
  summary: [
    "Over 15 years of professional software development across startups, scale-ups, and consultancies have taken me through diverse environments and teams across Brazil and Australia. I've worked with Golang, Java, Ruby, Kotlin, and TypeScript/Node.js—most recently as the primary stack for building distributed, event-driven systems on AWS—across cloud environments (AWS, GCP), learning to adapt quickly to different organisational contexts and technical challenges.",
    ...
    "Over the past year I've been using AI tooling daily in production work—starting with Cursor AI and then switching to Claude Code—across a full product build. Beyond the tooling itself, I've been paying close attention to how AI changes the way I think about system design, where it adds real leverage, and where it introduces new kinds of debt. If your organisation needs hands-on help with event sourcing adoption, distributed TypeScript systems, or strengthening engineering practices, I bring proven experience from full platform builds and large-scale legacy migrations.",
  ],
  facts: {
    Residence:
...
The Notion-based system revealed critical bottlenecks: business processes built directly on top of Notion created deep coupling that required multiple iterations to decouple, poor technical and product observability, platform flakiness, and substantial manual operational overhead. Since Notion is not designed as a production database, removing this dependency was critical to avoid undermining the product's potential. After implementing initial features to enable sales, I led the re-architecture of the entire system into a distributed, event-driven architecture built entirely in TypeScript/Node.js—using Lambda, SQS, SNS, EventBridge, and DynamoDB. I facilitated Event Storming workshops involving product, operations, sales, and marketing teams to inform the domain model and system boundaries.
...
The AI tooling space is moving fast—models, tools, and techniques are changing month to month—and I've been treating this period as one of active experimentation and deliberate learning rather than settled practice. Throughout the engagement I used AI coding assistants as a regular part of my workflow—Cursor AI for the first three months, then Claude Code for the remainder—keeping an eye on what's emerging and adjusting as things evolved. This gave me a sustained, hands-on view of where these tools show real promise and where they still need careful oversight.
`,
    },
    {
